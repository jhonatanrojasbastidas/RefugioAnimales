			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item">
							<a class="nav-link active" href="<?= site_url('/registro/animales')?>">Registro Animales</a>
						</li>
						<li class="nav-item">
        ...
        <div class="container mb-5">
             <div class="row mt-5 d-flex justify-content-center">
                <div class="col-12 col-md-5">
                    ...
                    <form action="<?= site_url('/registro/animales/new')?>" method="POST" class="mt-4">
                        <div class="mb-3">
                    ...
                    <div class="d-grid gap-2">
                            <button class="btn boton" type="submit">Registrar Animal</button>
                        </div>

...
$routes->get('/registro/animales', 'Animal::index');
$routes->post('/registro/animales/new', 'Animal::registrarAnimal');
$routes->get('/buscar/animales', 'Animal::buscar');
$routes->get('/animal/eliminar/(:num)', 'Animal::eliminarAnimal/$1');
